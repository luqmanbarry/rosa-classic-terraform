...
vpc_name="classic-1092"

vpc_id="vpc-038c85b88a8bc6fac"
...
private_subnet_ids=["subnet-09bd92a39e752bbb6","subnet-0aec66f604ebbb27a","subnet-0cfe91f5155f145ca"]

public_subnet_cidrs=["10.50.101.0/24","10.50.102.0/24","10.50.103.0/24"]

public_subnet_ids=["subnet-0559fb30500179924","subnet-0846f0ac1e2e0624b","subnet-0db7c4d7e0b50799a"]

availability_zones=["us-east-2a","us-east-2b","us-east-2c"]

hosted_zone_id="Z01926689JZMRWI58CBF"

base_dns_domain="non-prod.engineering.example.com"

vault_addr="https://vault.apps.classic-acm-hub.dlhq.p1.openshiftapps.com"

aws_additional_compute_security_group_ids=["sg-0056b6580ffb34ce4"]

aws_additional_control_plane_security_group_ids=["sg-0056b6580ffb34ce4"]

aws_additional_infra_security_group_ids=["sg-0056b6580ffb34ce4"]
