...
vpc_name="classic-103"

vpc_id="vpc-06225c6f4f4754e1b"
...
private_subnet_ids=["subnet-00f9c7d27b3040c2f","subnet-0e3a52142eef80671","subnet-0f31d5a1104b1ecb4"]

public_subnet_cidrs=["10.50.101.0/24","10.50.102.0/24","10.50.103.0/24"]

public_subnet_ids=["subnet-08b5456078c68573d","subnet-09c57697c15b29f91","subnet-0c0ef4eee8dd39f72"]

availability_zones=["us-west-2a","us-west-2b","us-west-2c"]

hosted_zone_id="Z091659331IWPWBU1W2M6"

base_dns_domain="non-prod.engineering.example.com"

vault_addr="https://vault.apps.classic-102.swew.p1.openshiftapps.com"

aws_additional_compute_security_group_ids=["sg-01cf755e94d4d96a6"]

aws_additional_control_plane_security_group_ids=["sg-01cf755e94d4d96a6"]

aws_additional_infra_security_group_ids=["sg-01cf755e94d4d96a6"]
