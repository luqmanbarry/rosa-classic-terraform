...
business_unit="platform-eng"

aws_account="844525928388"

vpc_name="rosa-secondary"

vpc_id="vpc-013b6b34efed9c5c2"
...
tfstate_s3_bucket_name="rosa-aws-regional-dr-demo"
...
private_subnet_ids=["subnet-0ab2a76c9f1f3a1db","subnet-0b5a315de4d9f615c","subnet-0d2d0209a10d53100"]

public_subnet_cidrs=["10.50.101.0/24","10.50.102.0/24","10.50.103.0/24"]

public_subnet_ids=["subnet-00973eab1e8ddd29d","subnet-02c34a5f638e7ec2c","subnet-06ccde4509b4b9b38"]

availability_zones=["us-west-2a","us-west-2b","us-west-2c"]

hosted_zone_id="Z07160251U4AO0YH7KRAC"

base_dns_domain="non-prod.platform-eng.example.com"

vault_addr="https://vault.apps.classic-102.swew.p1.openshiftapps.com"

aws_additional_compute_security_group_ids=["sg-0dc404b67fb046479"]

aws_additional_control_plane_security_group_ids=["sg-0dc404b67fb046479"]

aws_additional_infra_security_group_ids=["sg-0dc404b67fb046479"]
...
additional_tags={"business_unit"="platform-eng","cost_center"="1010101010","deployer_role"="ManagedOpenShift-Installer-Role","red-hat-clustertype"="rosa","team-maintainer"="platform-ops"}

default_mp_labels={"business_unit"="platform-eng","cost_center"="1010101010","red-hat-clustertype"="rosa","team-maintainer"="platform-ops"}
