...
business_unit="demo-time"

aws_account="889969646615"

vpc_name="classic-1091"

vpc_id="vpc-07cd3762760c99af6"
...
tfstate_s3_bucket_name="rosa-classic-acm-demo"
...
private_subnet_ids=["subnet-0331e6efa9308ad64","subnet-0a8a1fa658968ce27","subnet-0c94458e0c535a82a"]

public_subnet_cidrs=["10.50.101.0/24","10.50.102.0/24","10.50.103.0/24"]

public_subnet_ids=["subnet-08c982e576e83d894","subnet-0e1abf0ab1fc0ac5c","subnet-0f36e4c1b2d709745"]

availability_zones=["us-east-2a","us-east-2b","us-east-2c"]

hosted_zone_id="Z0683388HSPUTAA4V4WZ"

base_dns_domain="non-prod.demo-time.example.com"

vault_addr="https://vault.apps.classic-acm-hub.gsze.p1.openshiftapps.com"

aws_additional_compute_security_group_ids=["sg-0a5687067ea7e6e37"]

aws_additional_control_plane_security_group_ids=["sg-0a5687067ea7e6e37"]

aws_additional_infra_security_group_ids=["sg-0a5687067ea7e6e37"]
...
additional_tags={"business_unit"="demo-time","cost_center"="1010101010","deployer_role"="ManagedOpenShift-Installer-Role","red-hat-clustertype"="rosa","team-maintainer"="platform-ops"}

default_mp_labels={"business_unit"="demo-time","cost_center"="1010101010","red-hat-clustertype"="rosa","team-maintainer"="platform-ops"}
