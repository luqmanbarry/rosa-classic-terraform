...
export TF_VAR_aws_account="487098163730"
...
export TF_VAR_cluster_name="hcp-1091" # Max str length 15 characters
export TF_VAR_tfstate_s3_bucket_name="rosa-acm-demo"
...
export TF_VAR_acmhub_cluster_name="rosa-acm-hub"
export TF_VAR_ocp_version="4.15.12"
...
export TF_VAR_vault_addr="https://vault.apps.rosa.hcp-acm-hub.xhvs.p3.openshiftapps.com" # Change this to your vault address - Use .ci/vault-deploy.sh to deploy one inside OCP
